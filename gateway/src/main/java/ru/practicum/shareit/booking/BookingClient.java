...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findAllBookingsByUserId(long userId, BookingState state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> findAllBookingsForItemsUser(long userId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
